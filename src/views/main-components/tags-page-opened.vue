        ...
        <div class="close-all-tag-con">
            <Dropdown transfer @on-click="handleTagsOption">
                <Button size="small" type="primary">
                    {{$t('labelOptions')}}
                    <Icon type="ivu-icon ivu-icon-md-arrow-dropdown" size="17"></Icon>
                </Button>
                <DropdownMenu slot="list">
                    <DropdownItem name="clearAll">{{$t('clearAll')}}</DropdownItem>
                    <DropdownItem name="clearOthers">{{$t('clearOthers')}}</DropdownItem>
                </DropdownMenu>
            </Dropdown>
        </div>
